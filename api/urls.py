...
urlpatterns = [
    ...
    path('<str:country>/titles/ec_info', views.ec_info_2, name="ecinfo2"),
    ...
    path('<str:country>/', views.purcahse_title, name="purchase"),  
    ...
    path('my/votable_titles', views.votable_titles, name="votable_titles_get"),
    path('my/votes/!put', views.votes_put, name="votes_put"),
]
