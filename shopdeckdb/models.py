...
class title_updates(models.Model):
    id = models.AutoField(primary_key=True)
    main_title = models.ForeignKey(Title, on_delete=models.CASCADE, related_name='main_updates')
    update_title = models.ForeignKey(Title, on_delete=models.CASCADE, related_name='update_for')

    def __str__(self):
        return f"Update {self.update_title.name} for {self.main_title.name}"
